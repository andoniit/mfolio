    ...
    <main id="contact" className={styles.main}>
      <div className={styles.body}>
        ...
        <div className={styles.contactEmailLine}>
          <p>
          Let's have a conversation about how I can contribute to your success <a href="mailto:anikap1999@gmail.com" className={styles.emailLink}>anikap1999@gmail.com</a>
          </p>
        </div>
